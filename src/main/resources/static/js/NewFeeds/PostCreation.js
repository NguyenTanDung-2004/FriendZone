...
function createPostFromObjectPostInfo(){
    ...
    arrayDivLike = document.querySelectorAll("body > div.divMain > div.divCenter.divMainChild1 > div.divPost > div.divLikeCommentShare > div.divLike.divLikeCommentShareChild1");
        ...
        arrayDivLike[i].addEventListener("click", () => 
            {
                ...
                if (iLike.className == 'bi bi-hand-thumbs-up'){
                    changeStyleAndClassLiked(iLike, p); // this function in LikePost.js
                    likePost(postId); // this function in LikePost.js
                }
                else{
                    deleteLikePost(postId); // this function in LikePost.js
                    changeStyleAndClassNormalLike(iLike, p); // LikePost.js
                }
            }
        )
    }
...
function createDivPostHeaderShare(imgSrc, nameUser, formattedTime, scope,  sharedUserName, sharedUserId, postUserId){
    // Create the main div element
    var divPostHeader = document.createElement('div');
    divPostHeader.className = 'divPostHeader';
    ...
    // Create the p element for the name
    var pNameUser = document.createElement('p');
    pNameUser.className = 'pNameUser1';
    ...
    {
        window.location = "http://localhost:8080/FriendZone?id=" + postUserId;
    }
    )
...
function createDivLikeCommentShareChild(index){
    ...
    divShare.addEventListener("click", () => 
    {
        ...
        document.querySelector("body > div.divMain > div.divCenter.divMainChild1 > div.divCreatePost").click();
...
function eventForTagedFriend(){
    var arrayDivPost = document.querySelectorAll("body > div.divMain > div.divCenter.divMainChild1 > div.divPost");
...
function eventForOthersFile(){
    var arrayDivPost = document.querySelectorAll("body > div.divMain > div.divCenter.divMainChild1 > div.divPost");
    console.log(arrayDivPost);
    for (let i = 0; i < arrayDivPost.length; i++){
        var arrayPDivPost = arrayDivPost[i].querySelectorAll("#divDownLoadFile");
        console.log(arrayPDivPost);
        for (let j = 0; j < arrayPDivPost.length; j++){
            arrayPDivPost[j].addEventListener("click", () => 
                {
...
function displaySettingPost(){
    var arrayISettingPost = document.querySelectorAll("body > div.divMain > div.divCenter.divMainChild1 > div.divPost > div.divPostHeader > i");
    var arrayDivSettingPost = document.querySelectorAll("body > div.divMain > div.divCenter.divMainChild1 > div.divPost > div.divSettingPost");
    for (let i = 0; i < arrayISettingPost.length; i++){
        if (userId != objectPostInfo[i].userId){
            arrayISettingPost[i].style.display = "none";
        }
...
function coppyLink(){
    var arrayCoppyLink = document.querySelectorAll("body > div.divMain > div.divCenter.divMainChild1 > div.divPost > div.divSettingPost > div.divCopyLink");
...
function updatePost(){
    var arrayUpdatePost = document.querySelectorAll("body > div.divMain > div.divCenter.divMainChild1 > div.divPost > div.divSettingPost > div.divEdit")
    for (let i = 0; i < arrayUpdatePost.length; i++){
        arrayUpdatePost[i].addEventListener("click", () => 
            {
                window.location = "http://localhost:8080/FriendZone?updatePost=1&postId=" + objectPostInfo[i].id;
            }
        )
    }
}
...
function deletePost(){
    var arrayDivPost = document.querySelectorAll("body > div.divMain > div.divCenter.divMainChild1 > div.divPost > div.divSettingPost > div.divDelete");
    var arrayDeletePost = document.querySelectorAll("body > div.divMain > div.divCenter.divMainChild1 > div.divPost > div.divSettingPost > div.divDelete");
...
function displayComment(){
    var arrayDisplayComment = document.querySelectorAll("body > div.divMain > div.divCenter.divMainChild1 > div.divPost > div.divLikeCommentShare > div.divComment.divLikeCommentShareChild");
...
// function access personalpage from post
function accessToPersonalPageFromPost(){
    var arrayPUserName = document.querySelectorAll("body > div.divMain > div.divCenter.divMainChild1 > div.divPost > div.divPostHeader > div > div > p");
    for (let i = 0; i < arrayPUserName.length; i++){
        var arrayList = arrayPUserName[i].querySelectorAll("span");
        console.log(arrayList);
        if (arrayList.length == 0){
            arrayPUserName[i].addEventListener("click", () => 
            {
                window.location = "http://localhost:8080/FriendZone?id=" + objectPostInfo[i].userId;
            }
            )
        }
    }
