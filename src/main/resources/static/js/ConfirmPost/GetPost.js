function getPost(){
    ...
    fetch('/handleGroup/getPostToConfirm?groupId=' + groupId, {
        method: 'GET',
        headers: {
...
function createDivLikeCommentShareChild(postId, flagLiked){
    ...
    var divConfirm = document.createElement("p");
    divConfirm.innerHTML = "Confirm";
    divConfirm.style.backgroundColor = "rgb(8, 102, 255)";
    divConfirm.style.color = "white";
    divConfirm.style.cursor = "pointer";
    divConfirm.style.textAlign = "center";
    divConfirm.style.fontWeight = "600";
    divConfirm.style.width = "40%";
    divConfirm.style.padding = "8px 8px"
    divConfirm.style.borderRadius = "10px"
    divConfirm.addEventListener("click", () => 
    {
        const confirm1 = confirm("Are you sure you want to confirm this post?");
        if (confirm1){
            confirmPost(postId);
        }
    }
    ...
    var divDelete = document.createElement("p");
    divDelete.innerHTML = "Delete";
    divDelete.style.backgroundColor = "red";
    divDelete.style.color = "white";
    divDelete.style.cursor = "pointer";
    divDelete.style.textAlign = "center";
    divDelete.style.fontWeight = "600";
    divDelete.style.width = "40%";
    divDelete.style.padding = "8px 8px"
    divDelete.style.borderRadius = "10px"
    divDelete.addEventListener("click", () => 
    {
        const confirm1 = confirm("Are you sure you want to delete this post?");
        if (confirm1){
            deletePost(postId);
        }
    }
    ...
    divLikeCommentShare.appendChild(divConfirm);
    divLikeCommentShare.appendChild(divDelete);
...
function confirmPost(postId){
    const token = getCookie("jwtToken");
    var groupId = getParam("groupId");
    fetch('/handleGroup/confirmPost?postId=' + postId + "&groupId=" + groupId, {
        method: 'POST',
        headers: {
            'Authorization': 'Bearer ' + token
        }
